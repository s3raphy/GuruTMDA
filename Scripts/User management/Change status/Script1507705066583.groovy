...
WebUI.click(findTestObject('Chage status/Page_Guru TMDA/a_User Management'))

WebUI.setText(findTestObject('Chage status/Page_Guru TMDA (2)/input_ng-untouched ng-valid ng'), 'fortest')
...
WebUI.click(findTestObject('Chage status/Page_Guru TMDA (2)/button_SUBMIT'))

WebUI.verifyElementPresent(findTestObject('Chage status/Page_Guru TMDA (6)/div_User Management Successful'), 2, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Chage status/Page_Guru TMDA (2)/button_'))

WebUI.waitForElementNotPresent(findTestObject('Chage status/Page_Guru TMDA (5)/div_w3-padding-32 w3-center'), 0)
